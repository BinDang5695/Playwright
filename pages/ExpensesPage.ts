...
export class ExpensesPage extends BasePage {
    ...
    private createdExpense(name: string) {
    ...
    private expenseNote(name: string) {
    ...
    private expenseDate(date: string) {
        return this.page.locator(`//span[normalize-space()='${date}']`)
    }

    private expenseAmount(amount: string) {
    ...
    private expenseRef(amount: string) {
        return this.page.locator(`//span[normalize-space()='${amount}']`)
    }

    private expenseRepeat(date: string) {
        return this.page.locator(`//span[normalize-space()='${date}']`)
    }

    private expenseCyclesRemaining(date: string) {
        return this.page.locator(`//b[normalize-space()='${date}']`)
    }

    private attachedReceipt(receiptName: string) {
    ...
    async searchExpense(data: Expense) {
        await this.inputSearchExpenses.fill(data.name);
    }

    async hoverToExpense(data: Expense) {
